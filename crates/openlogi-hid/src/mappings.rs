...
//! (Bolt pairing register and `0x0005` marketing type), battery level/status,
//! and serial-number normalisation. No I/O — split from `inventory` purely to
//! keep that file within size bounds.
